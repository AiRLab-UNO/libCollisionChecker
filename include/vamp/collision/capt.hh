...
namespace vamp::collision
{
    ...
    struct CAPT
    {
        ...
        struct BuildFrame
        {
            ...
            // This frame's index in the test_v0 buffer.
            uint32_t i;
        ...
        auto collides_simd(const std::array<FVectorT, 3> &centers, FVectorT radii) const noexcept -> bool
        {
            ...
            // we can't just test_v0 if the query is in the AABB, but rather if it's in the AABB when fattened by
            ...
            // Convert the terminal test_v0 indices to reference indices for the affordance buffer
        ...
        // The test_v0 buffer for this tree.
