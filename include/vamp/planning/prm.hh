...
//                vamp::rng::Halton<3> rng) noexcept -> PlanningResult<dimension>
//        {
//            return solve(start, static_cast<const Vector<3>>(static_cast<const Vector<3>>(static_cast<const Vector<3>>(static_cast<const Vector<3>>(std::vector<Configuration>{
//                    goal})))), environment, settings, rng);
//        }
