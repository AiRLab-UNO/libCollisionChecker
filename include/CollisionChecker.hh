...
DECLARE_PIMPL_CLASS(QuadtreeCollisionChecker, quadtree)
DECLARE_PIMPL_CLASS(OctreeCollisionChecker, octree)
DECLARE_PIMPL_CLASS(OccupancyMap, occupancy)
DECLARE_PIMPL_CLASS(FCL, fcl)
DECLARE_PIMPL_CLASS(VampCollisionChecker, vamp)
